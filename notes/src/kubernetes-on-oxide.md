...
独自インフラ上へのKubernetes統合の具体事例。[[cluster-api|Cluster API]]・[[kubernetes-cloud-controller-manager|CCM]]・[[container-storage-interface|CSI]]という拡張機構が実際にどう使われる（そしてどこで摩擦が起きる）かを示すケーススタディになっている。
