...
Development（開発）・Security（セキュリティ）・Operations（運用）を統合したソフトウェア開発アプローチ。[[devops|DevOps]]（開発と運用の一体化による高速なデリバリー）に、セキュリティを第3の柱として組み込んだもの。
...
- [DevSecOps とは？をわかりやすく解説 - Red Hat](https://www.redhat.com/en/topics/devops/what-is-devsecops)
- [What is DevSecOps? | IBM](https://www.ibm.com/think/topics/devsecops)
- [DevSecOps とは? - AWS](https://aws.amazon.com/what-is/devsecops/)
