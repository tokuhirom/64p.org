...
Moonshot AIが2026年4月20日にHugging Faceで重みを公開した汎用モデル。1兆パラメータのネイティブマルチモーダルMoEで、トークンあたり320億のアクティブパラメータを持つ。[[open-weight-llm-moc|オープンウェイトLLM MOC]]の一員で、コーディング特化の後継[[kimi-k2-7|Kimi K2.7 Code]]、上位フラッグシップの[[kimi-k3|Kimi K3]]と同系列。
