...
証明書の寿命がどんどん短くなっていく流れは、「証明書の更新は自動化されているのが当たり前」という前提が業界標準になったことの現れと言える。手動更新を前提とした運用は今後成り立たなくなっていく。日本の学術機関向け認証局[[upki-certs-nii|UPKI電子証明書発行サービス]]が2025年11月にACME対応したのも、この流れの一環といえる。

## CTログの運用

発行した証明書を[[certificate-transparency|Certificate Transparency]]の仕組みに乗せるべく、「Sycamore」「Willow」「Twig」という複数のCTログを自ら運用し、複数の独立したログへ冗長的に投稿している。
