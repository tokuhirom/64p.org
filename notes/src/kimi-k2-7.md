...
Moonshot AIが2026年6月12日にリリースした、[[kimi-k2-6|Kimi K2.6]]のアーキテクチャ(1兆パラメータ[[moe|MoE]]、アクティブ320億、Modified MITライセンス)を継承しつつコーディング能力に特化してファインチューンした後継モデル。K2.6が汎用モデルであるのに対し、K2.7 Codeはコーディング専用という位置づけ。[[open-weight-llm-moc|オープンウェイトLLM MOC]]の一員。
