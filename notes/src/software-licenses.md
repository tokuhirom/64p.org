...
ソフトウェアライセンス、特に[[copyleft|コピーレフト]]の強度とsource-availableの潮流を見渡すハブノート。

## 基礎概念

- [[copyleft|コピーレフト]] — 派生物にも同じ自由を強制するライセンス手法。以下の系譜全体を貫く土台
- [[osi|OSI]] — Open Source Definitionを管理し、「何がオープンソースか」を判定する団体
...
- [[business-source-license|BSL]] — 本番利用を制限しつつ、最長4年の時限式で自動的にOSSへ変わる
