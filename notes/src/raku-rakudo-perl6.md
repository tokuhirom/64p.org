...
- **Grammar（文法）**: Perlの正規表現を拡張した「rules」により、PEGやANTLR相当のパーサーを言語内蔵で書ける。
...
- サイト（[tokuhirom.github.io/mutsu](https://tokuhirom.github.io/mutsu/)）はWebAssembly化したmutsu自身で動いており、チュートリアルやプレイグラウンドを提供している。
