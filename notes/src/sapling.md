...
CLIコマンド名は`sl`。Metaが開発・社内利用しているソース管理システム。使いやすさとスケーラビリティを重視して設計されている。CLIはもともとMercurialをベースにしており、UIや機能の多くをMercurialから継承している。
...
- Git/Mercurialユーザーにとって基本概念はなじみやすく、コミットスタックの操作や誤操作からの復旧が大幅に簡単になっているとされる。
