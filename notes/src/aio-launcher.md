...
- Android標準ウィジェットにも対応
- **Luaスクリプト**でウィジェットや検索結果を自作・拡張できる(v4.0以降)。スクリプト集は[GitHub (zobnin/aiolauncher_scripts)](https://github.com/zobnin/aiolauncher_scripts)で公開されている(ランチャー本体はオープンソースではない)
