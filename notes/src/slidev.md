...
同じくMarkdownベースのプレゼンテーションツールに[[marp]]がある。Slidevはインタラクティブなライブコーディングやコンポーネント埋め込みなど「Webアプリとしてのスライド」寄りなのに対し、Marpは静的なPDF/PPTX/HTML出力の再現性を重視したCLI/VS Code拡張中心のツールという違いがある。
