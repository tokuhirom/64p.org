...
- 継続的[[refactoring|リファクタリング]]・継続的自動単体テスト・継続的インテグレーションなど、他のXPプラクティスと組み合わせて使うことが前提。これらを伴わずにYAGNIだけを適用すると、コードが散らかり、大規模な修正が必要になる「[[technical-debt|技術的負債]]」につながりうる、という注意点も指摘されている。
